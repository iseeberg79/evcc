...
// MockBatteryHoldChargePowerLimiter is a mock of BatteryHoldChargePowerLimiter interface.
type MockBatteryHoldChargePowerLimiter struct {
	ctrl     *gomock.Controller
	recorder *MockBatteryHoldChargePowerLimiterMockRecorder
	isgomock struct{}
}

// MockBatteryHoldChargePowerLimiterMockRecorder is the mock recorder for MockBatteryHoldChargePowerLimiter.
type MockBatteryHoldChargePowerLimiterMockRecorder struct {
	mock *MockBatteryHoldChargePowerLimiter
}

// NewMockBatteryHoldChargePowerLimiter creates a new mock instance.
func NewMockBatteryHoldChargePowerLimiter(ctrl *gomock.Controller) *MockBatteryHoldChargePowerLimiter {
	mock := &MockBatteryHoldChargePowerLimiter{ctrl: ctrl}
	mock.recorder = &MockBatteryHoldChargePowerLimiterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockBatteryHoldChargePowerLimiter) EXPECT() *MockBatteryHoldChargePowerLimiterMockRecorder {
	return m.recorder
}

// SetHoldChargePower mocks base method.
func (m *MockBatteryHoldChargePowerLimiter) SetHoldChargePower(power float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetHoldChargePower", power)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetHoldChargePower indicates an expected call of SetHoldChargePower.
func (mr *MockBatteryHoldChargePowerLimiterMockRecorder) SetHoldChargePower(power any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetHoldChargePower", reflect.TypeOf((*MockBatteryHoldChargePowerLimiter)(nil).SetHoldChargePower), power)
}
