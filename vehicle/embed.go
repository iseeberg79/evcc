...
type embed struct {
	...
	DisableGradient_ bool             `mapstructure:"disableGradient"`
}
...
// DisableGradient returns whether SOC gradient recalibration should be disabled
func (v *embed) DisableGradient() bool {
	return v.DisableGradient_
}
